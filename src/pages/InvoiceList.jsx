...
const InvoiceList = () => {
  ...
  const encodedData = encodeURIComponent(JSON.stringify(selectedInvoices));
        ...
        <Card className="d-flex p-3 p-md-4 my-3 my-md-4 ">
            ...
            <div className="d-flex flex-column">
              <div className="d-flex flex-row align-items-center justify-content-between">
                ...
                <div className="d-flex gap-2">
                  ...
                  {
                    <Button variant="primary  mb-2 mb-md-4" onClick={handleModify}>
                      {modify ? "Cancel" : "Modify all"}
                    </Button>
                  }
                </div>
                <div className="d-flex gap-2">
...

          {
            ...
            <div className="align-self-center ">
              <Link to={`/edit-all?data=${encodedData}`}>
                <Button variant="primary">Edit selected</Button>
              </Link>
            </div>
          }
        </Card>
...
const InvoiceRow = ({ invoice, navigate, modify, setSelectedInvoices }) => {
  ...
  return (
    <tr>
      ...
      </td>
      {
        ...
        <td style={{ width: "5%" }}>
          <div className="d-flex align-items-center  justify-content-center gap-2" >
            <input type="checkbox" onChange={handleBulkEdit} />
          </div>
        </td>
      }
      <InvoiceModal
